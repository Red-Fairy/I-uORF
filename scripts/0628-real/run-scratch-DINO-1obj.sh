...
DATAROOT=${1:-'/viscam/redfairy/image_generation/datasets/ABO-chairs-1obj'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
CUDA_VISIBLE_DEVICES=0 python train_without_gan.py --dataroot $DATAROOT --n_scenes 648 --n_img_each_scene 2 \
    ...
    --coarse_epoch 1000 --niter 1000 --percept_in 50 --no_locality_epoch 100 \
    --exp_id '0628/1obj-scratch-648-72-24' \
